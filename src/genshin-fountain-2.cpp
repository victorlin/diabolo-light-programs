...
const static Scene scenes[] PROGMEM = {
    ...
    {YELLOW_3, YELLOW_3, 1233},  // before umbrella
    {YELLOW_3, BLUE_2, 816},  // toss up
    {BLUE_2, YELLOW_3, 816},  // toss down
    {YELLOW_3, YELLOW_3, 1066},  // before umbrella
    {YELLOW_3, BLUE_2, 816},  // toss up
    {BLUE_2, YELLOW_3, 816},  // toss down
    {YELLOW_3, WHITE_3, 933},  // before umbrella
...
void loop() {
    ...
    // idk you can also uncomment this if you want
